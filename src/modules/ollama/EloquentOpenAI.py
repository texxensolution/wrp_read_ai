...
from src.modules.common import FeatureExtractor, AudioClassifier
...
class EloquentOpenAI:
    def __init__(self, model = 'gpt-3.5-turbo', classifier_path: str = "classifier.joblib"):
        ...
        self.audio_classifier = AudioClassifier('classifier.joblib')
    ...
    def perform_all_evaluation(self, given_script: str, transcription: str, audio_path: str):
        ...
        similarity_score = self.calculate_distance_levenshtein(
        ...
        classification_prob = self.audio_classifier.predict_prob(y, sr)

        print('classification', classification)
        print('classification probability:', classification_prob)
